...
.setDescription('<a:siren:710112422421069834> Biri Tutuklandı <a:siren:710112422421069834>')
.addField("Tutuklanan Kişi",kişi)
.addField("Hakim","<@"+message.author.id+">")

message.channel.send("Başarıyla Hapise Attım.")
